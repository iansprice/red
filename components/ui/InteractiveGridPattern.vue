...
const svgClass = computed(() =>
    cn("absolute inset-0 h-[120vh] w-[calc(100vw+41) border border-gray-400/30", props.className),
);

function getRectClass(index: number) {
  return cn(
      "stroke-gray-400/30 transition-all duration-100 ease-in-out [&:not(:hover)]:duration-500",
